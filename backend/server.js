...
app.use('/api/projects',require('./Routes/projectsRoutes')) // Basic Routes for bage projects
app.use('/api/authers',require('./Routes/autherRoutes'))
...
app.listen(port,() => console.log('Server is Started on 6000'))
